<%@ Page Title="Conductor" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Conductor.aspx.cs" Inherits="WebAgencia.Conductor" %>
...
<script src="../../assets/global/plugins/jquery-tags-input/jquery.tagsinput.min.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#btnListUser,.SelectOpcUser').click(function () {
                $('#ListUser').fadeToggle("");
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
       <h3 class="page-title">Conductor
        <small>Lsiatdo de conductores</small>
    </h3>
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                   ...
                   <label class="col-md-3 control-label">Sexo :</label>
                        <div class="col-md-3">
                            <asp:DropDownList ID="ddlMuelle" class="form-control " runat="server">
    ...
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cube"></i>Conductores
            </div>
            <div class="tools">
